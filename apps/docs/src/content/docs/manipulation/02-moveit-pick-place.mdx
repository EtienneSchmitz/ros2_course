...
1. Onglet **Planning** → glissez la sphère interactive autour de la pince pour une
   cible cartésienne, ou choisissez une **pose nommée** dans *Goal State*.
2. **Plan** : MoveIt cherche une trajectoire.
3. **Execute** : elle est jouée sur le bras dans Gazebo.
