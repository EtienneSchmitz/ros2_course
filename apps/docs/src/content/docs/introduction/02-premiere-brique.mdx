...
Avant de coder, voici **où l'on va**. Le fil rouge de la semaine est un **robot de
mission** : il **détecte** un objet (caméra), **le saisit** (bras SO-101), puis **navigue**
(base mobile LeKiwi) vers une **zone de dépôt** choisie selon la classe de l'objet.
...
mobile) — **sans changer vos interfaces**. Aux **Jours 5-6**, vous assemblerez le tout.
...
**action** pour une tâche longue et annulable. Ces interfaces sont le **contrat** qui
restera stable quand les nœuds factices céderont la place aux vrais robots — soignez-les.
</Aside>
